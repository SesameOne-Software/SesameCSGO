...
vec3_t& __fastcall hooks::get_eye_angles( REG ) {
	...
	static auto ret_to_thirdperson_pitch = pattern::search( _( "client.dll" ), _( "F3 0F 10 54 24 ? 51 8B 8E" ) ).get< std::uintptr_t >( );
	static auto ret_to_thirdperson_yaw = pattern::search( _( "client.dll" ), _( "8B CE F3 0F 10 00 8B 06 F3 0F 11 44 24 ? 8B 80 ? ? ? ? FF D0" ) ).get< std::uintptr_t >( );
