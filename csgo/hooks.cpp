...
void __fastcall hooks::framestagenotify_hk( REG, int stage ) {
	...
	/*
	@CBRS
		Store lag records here on stage 4
		Why?
		because fuck clientside interpolation + anim updates
		...also where you should update animations. mine are tied together, but if they're seperate do that here too
		as long as poses are made correctly the player will render fine-ish
	*/
