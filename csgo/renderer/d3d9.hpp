...
namespace render {
	...
	void create_font ( void** font, const std::string_view& family, int size, bool bold );
	...
	void text ( int x, int y, std::uint32_t color, void* font, const std::string_view& text, bool shadow = false, bool outline = false );
