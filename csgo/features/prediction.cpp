...
namespace prediction_util {
	...
	bool start ( ucmd_t* ucmd ) {
		...
		*reinterpret_cast< uint32_t* >( uintptr_t ( g::local ) + ( g::is_legacy ? N ( 0x3314 ) : N ( 0x3338 ) ) ) = reinterpret_cast< uintptr_t >( ucmd );
		*reinterpret_cast< ucmd_t* >( uintptr_t ( g::local ) + ( g::is_legacy ? N ( 0x326C ) : N ( 0x3288 ) ) ) = *ucmd;
		...
		*reinterpret_cast< uint32_t* > ( reinterpret_cast< uintptr_t >( ucmd ) + N ( 48 ) ) &= ~*reinterpret_cast< uint32_t* > ( reinterpret_cast< uintptr_t >( g::local ) + ( g::is_legacy ? N ( 0x330C ) : N ( 0x3330 ) ) );
		...
		const auto v16 = *reinterpret_cast< uint32_t* > ( reinterpret_cast< uintptr_t >( ucmd ) + N ( 48 ) );
	...
	bool end ( ucmd_t* ucmd ) {
		...
		*reinterpret_cast< uint32_t* >( reinterpret_cast< std::uintptr_t >( local ) + ( g::is_legacy ? N ( 0x3314 ) : N ( 0x3338 ) ) ) = 0;
