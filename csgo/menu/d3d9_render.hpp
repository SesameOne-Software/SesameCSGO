...
namespace sesui {
	namespace binds {
		...
		void text ( const sesui::vec2& pos, const sesui::font& font, const std::string& text, const sesui::color& color ) noexcept;
		void get_text_size ( const sesui::font& font, const std::string& text, sesui::vec2& dim_out ) noexcept;
